...
```json
{
  "calendar": [{
    ...
    "duration_minutes": 60,
    "price": 5000,
    "service_id": "uuid", "service_name": "Стрижка", "service_color": "#FF5733",
    "employee_id": "uuid", "employee_name": "Анна",
    "location_id": "uuid", "location_name": "Салон на Абая",
    "customer_id": "uuid", "customer_name": "Иван",
    "customer_phone": "77001234567", "customer_comment": "..."
  }]
}
```
