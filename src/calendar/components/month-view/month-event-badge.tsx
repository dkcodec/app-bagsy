...
import { DraggableEvent } from "@/src/calendar/components/dnd/draggable-event";
import { EventDetailsDialog } from "@/src/calendar/components/dialogs/event-details-dialog";
