...
- `ANALYTICS_PAGE.md` — раздел аналитики (UI, роле-зависимый доступ, метрики, анимации)
- `ANALYTICS_API_SPEC.md` — ТЗ для бэка по аналитике (7 эндпоинтов, правила расчёта, форматы)
